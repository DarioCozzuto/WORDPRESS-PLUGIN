<?php
/*
Plugin Name: Currency Converter - Exchange Rates
Description: Fast loading and easy to use currency converter widget with builtin exchange rates by Currency.Wiki.
Author: Dario Cozzuto
Version: 1.0.1
*/
...
/* Adds a field for ratings in the top of the page */
...
function bcc_menu_page_display() {
	...
	?>
	<div class="wrap">
    	<h1 class="wp-heading-inline"><?php _e("Currency Tool Parameters - Dario Cozzuto"); ?></h1>
